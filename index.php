            ...
            <div class="row align-items-center">
              <div class="col-sm-12 col-md-12 col-lg-12 col-xl-7">
                <div class="slide__content">
                  <span class="slide__subtitle">Caring For The Health And Well Being Of Family.</span>
                  <h2 class="slide__title">Quality Health Care For Family. </h2>
          ...
          <div class="container">
            <div class="row align-items-center">
              <div class="col-sm-12 col-md-12 col-lg-12 col-xl-7">
                <div class="slide__content">
                  <span class="slide__subtitle">Caring For The Health And Well Being Of Family.</span>
                  <h2 class="slide__title">Delivering Best Medical Care.</h2>
                  <p class="slide__desc">The health and well-being of our patients and their health care team will
                    always be our priority, so we follow the best practices for cleanliness.</p>
                  <div class="d-flex flex-wrap align-items-center">
                    <a href="about-us.html" class="btn btn__white btn__rounded mr-30">
          ...
          <div class="col-sm-12 col-md-12 col-lg-4">
            <div class="feature-item feature-item-custom">
              <div class="feature__content">
                ...
                <p class="feature__desc">Qualified doctors available six days a week, view timetable to make an
                  appointment.</p>
        ...
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-7 offset-lg-1">
            <div class="heading-layout2">
              <h2 class="heading__subtitle color-primary">Helping Patients From Around the Globe!!</h2>
        ...
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-2">
            <div class="experience">
              <h2 class="experience__years">30</h2>
              <h3 class="experience__text">Years of Experience</h3>
              <p>We offer a wide range of care and support to our patients, from diagnosis to rehabilitation.</p>
            </div><!-- /.experience -->
          </div><!-- /.col-lg-2 -->
          <div class="col-sm-12 col-md-12 col-lg-5">
            <div class="video-banner-layout2 bg-overlay">
              <img src="assets/images/about/3.jpg" alt="about" class="w-100">
          ...
          <div class="col-sm-12 col-md-12 col-lg-5">
            <div class="about__text">
              ...
              <p class="heading__desc">We will work with you to develop individualised care plans, including management
                of
                diseases. We are
                committed to being the region’s premier healthcare network providing patient centered care that inspires
      ...
      <div class="container">
        <div class="row heading-layout2">
          ...
          <div class="col-sm-12 col-md-12 col-lg-6 offset-lg-1">
            <p class="heading__desc mb-30">Medcity has been present in Europe since 1990, offering innovative solutions,
              specializing in medical services for treatment of medical infrastructure. With over 100 professionals
              actively participates in numerous initiatives aimed at creating sustainable change for patients!</p>
            <div class="d-flex flex-wrap align-items-center mt-30 mb-60">
              ...
              <a href="doctors-modern.html" class="btn btn__secondary btn__link">
