...
<head>
  ...
  <title>Hospital Universitário de Canoas - Funam </title>
          ...
          <div class="row align-items-center">
            <div class="col-12">
              <p class="topbar__text text-center mb-0">
                ...
                <span>COVID-19 tools and resources: symptom checker, visitor restrictions, testing info and safety
                  measures. </span>
          ...
          <div class="collapse navbar-collapse" id="mainNavigation">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav__item has-dropdown">
                ...
                <ul class="dropdown-menu">
                  <li class="nav__item">
                    <a href="departments.html" class="nav__item-link">Departments </a>
                  </li><!-- /.nav-item -->
                  <li class="nav__item">
                    <a href="departments-single.html" class="nav__item-link">Departments Single</a>
                  </li><!-- /.nav-item -->
                </ul><!-- /.dropdown-menu -->
              </li><!-- /.nav-item -->
              <li class="nav__item has-dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="nav__item">
                    <a href="#" class="nav__item-link">Single Doctor 01</a>
                  </li> <!-- /.nav-item -->
                  <li class="nav__item">
                    <a href="#" class="nav__item-link">Single Doctor 02</a>
                  </li> <!-- /.nav-item -->
                </ul><!-- /.dropdown-menu -->
              </li><!-- /.nav-item -->
              <li class="nav__item has-dropdown">
